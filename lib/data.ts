...
export const CATEGORIES: Category[] = [
  { slug: 'grains', nameAr: 'حبوب وأرز', nameEn: 'Grains & Rice', icon: 'wheat' },
  { slug: 'oils', nameAr: 'زيوت وسمن', nameEn: 'Oils & Ghee', icon: 'droplet' },
  { slug: 'beverages', nameAr: 'مشروبات', nameEn: 'Beverages', icon: 'cup-soda' },
  { slug: 'canned', nameAr: 'معلبات', nameEn: 'Canned Food', icon: 'archive' },
  { slug: 'cleaning', nameAr: 'منظفات', nameEn: 'Cleaning', icon: 'spray-can' },
  { slug: 'snacks', nameAr: 'وجبات خفيفة', nameEn: 'Snacks', icon: 'cookie' },
  { slug: 'dairy', nameAr: 'ألبان', nameEn: 'Dairy', icon: 'milk' },
  { slug: 'sugar', nameAr: 'سكر ومحليات', nameEn: 'Sugar & Sweeteners', icon: 'candy' },
]
