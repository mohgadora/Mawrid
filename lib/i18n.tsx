...
const DICT = {
  ...
  partnerNavSubscription: { ar: 'الاشتراك', en: 'Subscription' },
  ...
  toastOrderStatusUpdated: { ar: 'تم تحديث حالة الطلب', en: 'Order status updated' },
  orderActionConfirm: { ar: 'تأكيد الطلب', en: 'Confirm order' },
  orderActionProcess: { ar: 'بدء التجهيز', en: 'Start processing' },
  orderActionPack: { ar: 'تم التغليف', en: 'Mark as packed' },
  orderActionShip: { ar: 'شحن الطلب', en: 'Mark as shipped' },
  orderActionOutForDelivery: { ar: 'خرج للتوصيل', en: 'Out for delivery' },
  orderActionDeliver: { ar: 'تم التسليم', en: 'Mark as delivered' },
  orderActionCancel: { ar: 'إلغاء الطلب', en: 'Cancel order' },
  orderNoActions: { ar: 'لا توجد إجراءات متاحة لهذه الحالة', en: 'No actions available for this status' },
