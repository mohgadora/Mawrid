...
const DICT = {
  ...
  // Guest checkout
  guestInfoTitle: { ar: 'معلومات التوصيل', en: 'Delivery information' },
  orContinueAsGuest: { ar: 'أو أكمل الطلب كضيف', en: 'Or continue as a guest' },
  signInToContinue: { ar: 'تسجيل الدخول', en: 'Sign in' },
  guestName: { ar: 'الاسم الكامل', en: 'Full name' },
  guestEmail: { ar: 'البريد الإلكتروني', en: 'Email' },
  guestPhone: { ar: 'رقم الهاتف', en: 'Phone number' },
  guestAddressLine: { ar: 'العنوان', en: 'Street address' },
  guestCity: { ar: 'المدينة', en: 'City' },
  guestOrderPlacedTitle: { ar: 'تم استلام طلبك!', en: 'Your order is placed!' },
  guestOrderRef: { ar: 'رقم الطلب', en: 'Order number' },
  guestOrderPlacedDesc: {
    ar: 'سنرسل تأكيداً وتفاصيل التتبّع إلى بريدك الإلكتروني.',
    en: 'We’ll email you a confirmation and tracking details.',
  },
