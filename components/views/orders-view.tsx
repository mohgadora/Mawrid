...
export function OrdersView() {
  ...
  const { data, error, isLoading, mutate } = useSWR<Awaited<ReturnType<typeof fetchOrders>>>('orders', fetchOrders)

  function handleReorder(lines: { productId: string; qty: number; productName?: string; productImage?: string | null }[]) {
    let added = 0
